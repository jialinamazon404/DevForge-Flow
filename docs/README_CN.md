...
| 文档 | 语言 | 内容 |
|------|------|------|
| [Conventions](../README.md) | 英文 | 主文档（英文版） |
| [Conventions](conventions.md) | 英文 | Git/Label/Spec/PR 规范、JSON Schema、最佳实践 |
| [规范文档](conventions_CN.md) | 中文 | Git/Label/Spec/PR 规范（中文版） |
| [本地开发流](local-development-flow.md) | 中文 | Local Skills 详细说明 |
